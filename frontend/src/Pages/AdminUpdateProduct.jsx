    ...
    <div className="min-h-screen bg-gray-200 p-8">
      ...
      <div className="w-full flex justify-center mt-6 mb-8">
        <div className="bg-gray-300 w-96 w-[600px] py-4 text-center">
          <h1 className="text-xl font-semibold">Admin - Update Item</h1>
        </div>
      </div>
      {/* Button Grid */}
      <div className="flex justify-center gap-24 mt-8">
        
       {/* Update a Product in Shop left box*/}
        ...
        {/* Update a Product From Shop right box*/}
        <div className="w-full max-w-md bg-grey p-6 pb-12 rounded-2xl shadow-sm">
            <div className="space-y-4">
            <div className=" text-center">
                <h1 className="text-xl font-semibold">Update Item in Shop</h1>
            </div>

            <div>
                <label className="block text-sm text-gray-800 mb-2">Select Item to Update</label>
